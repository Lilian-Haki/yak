...
if (empty($_SESSION['YAK'])) {
    ...
    if (isset($_GET['qid'])) {
        ...
        echo "<script>setTimeout(\"location.href = 'even';\",50);</script>";
        }else{
            ...
            <div class="panel-body">
                <div class="table-sorting table-responsive">
                    <table class="table table-striped table-bordered table-hover" id="tSortable22">
                        ...
                        <tbody>
                            <?php
                  $q = $conn->query("select * from staff where role='Event Manager' and (status=0 or status=3)");
                  $i=1;
                  ...
                  <tr>
                    ...
                    <td>
                        <?php if($r['status']==0){
                            ?>
                      <a href="even?qid=<?php echo ($r['id']*99970); ?>"
