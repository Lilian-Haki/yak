...
if (empty($_SESSION['YAK'])) {
    ...
    if (isset($_GET['qid'])) {
        $id=$_GET['qid']/99970;
        if(mysqli_query($conn, "UPDATE trainer set status=1,remarks='' where id='".$id."'")){
        echo "<script>alert('Account Approved.')</script>";
        echo "<script>setTimeout(\"location.href = 'trax';\",50);</script>";
        }else{
            ...
            <div class="panel-body">
                <div class="table-sorting table-responsive">
                    <table class="table table-striped table-bordered table-hover" id="tSortable22">
                        ...
                        <tbody>
                            <?php
                  $q = $conn->query("select * from trainer where status=2");
                  $i=1;
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="trax?qid=<?php echo ($r['id']*99970); ?>"
