...
if (empty($_SESSION['YAK'])) {
    ...
    if (isset($_GET['qid'])) {
        ...
        echo "<script>setTimeout(\"location.href = 'serx';\",50);</script>";
        }else{
    ...
    <div id="page-inner">
        <div class="panel panel-default" id="examples">
            <div class="panel-heading">
                Manage Rejected Service Managers
            </div>
            <div class="panel-body">
                <div class="table-sorting table-responsive">
                    <table class="table table-striped table-bordered table-hover" id="tSortable22">
                        ...
                        <tbody>
                            <?php
                  $q = $conn->query("select * from staff where role='Service Manager' and status=2");
                  $i=1;
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="serx?qid=<?php echo ($r['id']*99970); ?>"
